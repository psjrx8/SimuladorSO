...
def executar(tipoEscalonamento, tipoPaginacao, processos, logProcessoador):

    turnRound = 0 #Media do tempo de execucao

    if tipoEscalonamento == 1:
        Escalonamento.FIFO(tipoPaginacao, processos, memoriaRAM, memoriaVirtual, logProcessoador)
    elif tipoEscalonamento == 2:
        Escalonamento.SJF(tipoPaginacao, processos, memoriaRAM, memoriaVirtual, logProcessoador)
    elif tipoEscalonamento == 3:
        Escalonamento.robinRound(tipoPaginacao, processos, memoriaRAM, memoriaVirtual, logProcessoador)
    elif tipoEscalonamento == 4:
        Escalonamento.EDF(tipoPaginacao, processos, memoriaRAM, memoriaVirtual, logProcessoador)
...
logProcessoador = LogProcessador.LogProcessador()
...
executar(tipoEscalonamento, tipoPaginacao, processos, logProcessoador)